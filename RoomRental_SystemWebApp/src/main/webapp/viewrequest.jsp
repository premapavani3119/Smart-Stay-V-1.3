...
<div class="container mt-5">
    <h3 class="text-center">User Room Requests</h3>
    ...
    <table class="table table-bordered mt-4">
        ...
        <tr>
            ...
            <% if(role != null && role.equalsIgnoreCase("admin")) { %>
            <td>
                <!-- Always show buttons for admin -->
                <a href="UpdateBookingStatus?bookingid=<%=b.getBookingid()%>&status=Accepted"
                   class="btn btn-primary btn-sm">Accept</a>

                <a href="UpdateBookingStatus?bookingid=<%=b.getBookingid()%>&status=Rejected"
